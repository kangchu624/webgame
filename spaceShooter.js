...
// Import showGameMenu from script.js
import { showGameMenu } from './script.js';
...
function gameOver() {
  ...
  resetSpaceGame(); // Reset the game
  showGameMenu(); // Show the game menu again
}

// Function to reset the Space Shooter game
...
function updateSpaceGame() {
  ...
  requestAnimationFrame(updateSpaceGame);
}
...
export function startSpaceGame() {
  resetSpaceGame(); // Reset the game when starting
  updateSpaceGame();
}

export { resetSpaceGame };
